							...
							echo "<div class='col s12'>";
								echo "<div align='center'id='paginate1' class='pagination'>";																
									...
									if($total_num_pages>1)
									{
										...
										if($previous>=1)
										{
											echo "<li class='waves-effect'><a href='#' onclick=\"paginate_state({$previous},{$id})\"><i class='material-icons'>chevron_left</i><li>";
										}
										for($i=1;$i<=$total_num_pages;$i++)
										{
											...
											{
												echo "<li class='waves-effect'><a href='#' onclick=\"paginate_state({$i},{$id})\">{$i}</a></li>";
											}
										}									
										if($next<=$total_num_pages)
										{
											echo "<li class='waves-effect'><a href='#' onclick=\"paginate_state({$next},{$id})\"><i class='material-icons'>chevron_right</i></a><li>";
										}
									}
								echo "</div>";
							echo "</div>";
