...
$cKey = "ck_2b6de8f43c7439aead5fddf9c809a5025a70967a";
$cSec = "cs_8b2ecb7770b6f10336dfd066e71aa8fefd24a155";

try {

	$client = new WC_API_Client( 'http://localhost:8888/sandbox/printanything/', $cKey, $cSec, $options );
...
//	$orders = array($client->orders->get()); 
//    print_r(each($orders));
    echo "<pre>";
